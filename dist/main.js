...
class Project {
  constructor(name, color) {
    ...
    this.color = color;
    this.rendered = false;
    this.toDoList = (0,_TodoList__WEBPACK_IMPORTED_MODULE_0__.createTodoList)();
  }
...
class UI {
  ...
  static exampleProjects() {
    const exampleProject1 = (0,_Project__WEBPACK_IMPORTED_MODULE_0__.createProject)("Study", "black");
    const exampleProject2 = (0,_Project__WEBPACK_IMPORTED_MODULE_0__.createProject)("Work", "red");

    const exampleTask1 = (0,_Task__WEBPACK_IMPORTED_MODULE_1__.createTask)(
      "LeetCode",
      "Solve problems on LeetCode",
      "AUG 24 2024",
      "MEDIUM"
    );
    const exampleTask2 = (0,_Task__WEBPACK_IMPORTED_MODULE_1__.createTask)(
      "Todo List",
      "Solve problems on LeetCode",
      "AUG 11 2024",
      "MEDIUM"
  ...
  static addNewProject(event) {
    ...
    if (
      ...
      const newProject = (0,_Project__WEBPACK_IMPORTED_MODULE_0__.createProject)(name, color);
  ...
  static addNewTask(event) {
    ...
    const dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.format)(date, "MMM dd yyyy");
    const priority = document.querySelector("#priority").value;
    const projectSelected = document.querySelector(
      "#task-project-select"
    ).value;

    const task = (0,_Task__WEBPACK_IMPORTED_MODULE_1__.createTask)(name, description, dueDate, priority);
