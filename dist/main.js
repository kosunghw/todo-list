...
function compareDueDates(task1, task2) {
  return (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.compareAsc)(task1.dueDate, task2.dueDate);
}
...
class UI {
  static projectArray = [];
  static allTaskArray = new _TodoList__WEBPACK_IMPORTED_MODULE_2__["default"]();
  static inboxArray = new _TodoList__WEBPACK_IMPORTED_MODULE_2__["default"]();
  ...
  static exampleProjects() {
    const exampleProject1 = new _Project__WEBPACK_IMPORTED_MODULE_0__["default"]("Study", "black");
    const exampleProject2 = new _Project__WEBPACK_IMPORTED_MODULE_0__["default"]("Grocery Shopping", "red");

    const exampleTask1 = new _Task__WEBPACK_IMPORTED_MODULE_1__["default"](
      "LeetCode",
      "Solve problems on LeetCode",
      new Date("08-24-2024"),
      "MEDIUM"
    );
    const exampleTask2 = new _Task__WEBPACK_IMPORTED_MODULE_1__["default"](
      "Todo List",
      "Solve problems on LeetCode",
      new Date("08-11-2024"),
      "MEDIUM"
    ...
    const exampleTask3 = new _Task__WEBPACK_IMPORTED_MODULE_1__["default"](
      "Buy Kitchen Towels",
    ...
    console.log(
      (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.compareAsc)(exampleTask1.dueDate.getMonth(), new Date().getMonth())
    );
  ...
  static addNewProject(event) {
    ...
    if (
      ...
      const newProject = new _Project__WEBPACK_IMPORTED_MODULE_0__["default"](name, color);
  ...
  static addNewTask(event) {
    ...
    const task = new _Task__WEBPACK_IMPORTED_MODULE_1__["default"](name, description, dueDate, priority);
  ...
  static createTaskDiv(task) {
    ...
    taskDueDate.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.format)(task.dueDate, "MMM do',' yyyy");
  ...
  static getTodayTask() {
    ...
    const list = new _TodoList__WEBPACK_IMPORTED_MODULE_2__["default"]();
...
document.addEventListener("DOMContentLoaded", _modules_UI__WEBPACK_IMPORTED_MODULE_3__["default"].init);
