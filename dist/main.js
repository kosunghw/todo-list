...
class TodoList {
  ...
  filterBySeven() {
    this.taskArray = this.taskArray.filter((element) => {
      ...
      const sevenDayStr = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.format)(sevenDay, "yyMMdd"); // in format of 'yymmdd' (240831)
      const taskDueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.format)(element.dueDate, "yyMMdd");
...
function compareDueDates(task1, task2) {
  return (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.compareAsc)(task1.dueDate, task2.dueDate);
}
...
class UI {
  ...
  static deleteProject(target) {
    ...
    for (let i = 0; i < UI.allTaskArray.length; i++) {
      if (UI.allTaskArray.list[i].project === projectName) {
        UI.allTaskArray.deleteTask;
      }
    }
  ...
  static createTaskDiv(task) {
    ...
    taskDueDate.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.format)(task.dueDate, "MMM do',' yyyy");
